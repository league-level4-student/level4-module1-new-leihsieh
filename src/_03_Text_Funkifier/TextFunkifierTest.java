...
public class TextFunkifierTest {
	 ...
	 * modified in a way of your choosing that is different from those in previous
	 * steps.
	 * 
	 * 5. Create a matching JUnit test below to test for your custom String and make
	 * it pass.
	 */

	@Test
	public void testCustomString() {
		AddSpacesString ass = new AddSpacesString("This is another test");
		assertEquals("T h i s   i s   a n o t h e r   t e s t", ass.funkifyText());
	}
}
